...
function Breeds(router, dbConn, tl) {
    var _this = this;
    router.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var qr, qrr, breeds;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, AwaitableSQL_1.doQuery(dbConn, "SELECT * FROM breeds WHERE isEnabled = 1", [])];
                case 1:
                    qr = _a.sent();
                    if (qr.error) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AwaitableSQL_1.doQuery(dbConn, "SELECT * FROM breeds WHERE id_breeds = ? AND isEnabled = 1", [req.params.id])];
                case 1:
                    qr = _a.sent();
                    if (qr.error) {
                        tl.reportInternalError(res, qr.error);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AwaitableSQL_1.doQuery(dbConn, "INSERT INTO breeds \n                                        (name, create_datetime, edit_datetime) VALUES \n                                        (?, ?, ?);", [b.name, date, date])];
                case 1:
                    qr = _a.sent();
                    if (qr.error) {
                        tl.reportInternalError(res, qr.error);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AwaitableSQL_1.doEditElement(dbConn, "breeds", req.params.id, [
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AwaitableSQL_1.doQuery(dbConn, "UPDATE breeds \n                                        SET isEnabled = 0\n                                        WHERE id_breeds = ?", [req.params.id])];
                case 1:
                    qr = _a.sent();
                    if (qr.error) {
                        tl.reportInternalError(res, qr.error);
